...
//   // Returns an array of objects (menu items)
// getAllMenuItems: () => {
//   const query = {
//     name: 'get_all_menu_Items',
//     text: `SELECT *
...
// PREVIOUS CODE -- COMMENTED OUT WHILE WORKING OUT WHY JQUERY ISN'T SERVING DATA FROM THE DATABASE AS EXPECTED
// const { Pool } = require('pg');
